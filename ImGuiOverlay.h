...
- (void)setupWithDevice:(id<MTLDevice>)device commandQueue:(id<MTLCommandQueue>)queue colorPixelFormat:(MTLPixelFormat)pixelFormat;
- (void)beginFrameWithCommandBuffer:(id<MTLCommandBuffer>)commandBuffer renderPassDescriptor:(MTLRenderPassDescriptor *)rpd;
